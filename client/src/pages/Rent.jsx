    ...
    <div className="min-h-screen bg-gray-50 -mt-12">
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-600">Discover amazing rental properties that fit your lifestyle</p>
        </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 pt-6 border-t border-gray-200">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-3">
                  Max Rent: KSh {priceRange[1].toLocaleString()}
                </label>
                <input
                  type="range"
                  min="0"
        ...
        <div className="mb-4">
          <p className="text-gray-600">
            Showing <span className="font-semibold">{filteredProperties.length}</span> rental properties
          </p>
        </div>
        ...
        {filteredProperties.length > 0 ? (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="text-2xl font-bold text-blue-600 mb-4">
                    KSh {property.price.toLocaleString()} <span className="text-sm text-gray-600">/month</span>
                  </div>
          ...
          <div className="text-center py-12 bg-white rounded-lg">
            <p className="text-gray-600 text-lg">No rental properties found matching your criteria.</p>
          </div>
        )}
      </div>
    </div>
